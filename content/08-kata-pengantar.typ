...
#let kata-pengantar(data) = {
  ...
  [
    ...
    Penulis menyadari bahwa masih banyak kekurangan dalam pelaksanaan kerja praktik maupun
  ...
  enum(
    ...
    [Teman-teman penulis yang senantiasa memberikan semangat selama pelaksanaan KP.],
  )
