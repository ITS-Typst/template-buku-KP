// ============================================================
// WAJIB EDIT — BAB VI PENGUJIAN DAN EVALUASI
// ============================================================
...
[Jelaskan tujuan pengujian yang dilakukan.]

== Kriteria Pengujian

Penilaian atas pencapaian tujuan pengujian memperhatikan kriteria berikut:
...
#figure(
  caption: [Hasil Evaluasi Pengujian],
  table(
    columns: (1fr, 1fr),
    align: (left, center),
    [*Kriteria Pengujian*], [*Hasil Pengujian*],
    [Kriteria Pengujian 1], [Terpenuhi / Tidak Terpenuhi],
    [Kriteria Pengujian 2], [Terpenuhi / Tidak Terpenuhi],
  ),
)
